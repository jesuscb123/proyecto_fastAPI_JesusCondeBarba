...
3. Documentación de la API
  - Una vez que el contenedor esté corriendo, puedes acceder a la documentación interactiva (Swagger UI) para probar las rutas:
    [enlace para acceder a Swagger UI](http://localhost:8000/docs)
